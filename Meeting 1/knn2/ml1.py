...
from knn2.lib import proceed_and_show_image, get_dataset
from knn2.env import env_dataset

# load the MNIST digits dataset
mnist = get_dataset(env_dataset)
...
proceed_and_show_image(model, testData, testLabels)
